...
const ReceivedCards = (props) => {
 ...
 const handleReceived = async () => {
  ...
  }, [search, selectedButton,rowsPerPage, page,sortOrder,orderBy,handleCloseDialog]);
    ...
    <IconButton sx={{color:"#FCFCFC"}}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                All
                {/* ({receivedcards?.receivedcardsData?.dataValues?.Totalcardcount}) */}
              </Button>
              <Button
              ...
              >
                Appreciation
                {/* ({receivedcards?.receivedcardsData?.dataValues?.Appreciation} 
) */}
              </Button>
              <Button
              ...
              >
                Thanking
                {/* ({receivedcards?.receivedcardsData?.dataValues?.Thanking}) */}
              </Button>
            </Box>
            <TextField
              sx={{
        ...
        <TablePagination
          ...
          count={
            selectedButton === "All"
              ? receivedcards?.receivedcardsData?.dataValues?.totalCards
              : selectedButton === "Appreciation"
              ?  receivedcards?.receivedAppreciationData?.dataValues?.AppreciationCount
              : selectedButton === "Thanking"
              ?  receivedcards?.receivedThankingData?.dataValues?.ThankingCount
              : 0 
          }
