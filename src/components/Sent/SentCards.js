...
const SentCards = (props) => {
  ...
  const {
    ...
    getSentCardsAsync,
    sentcards,
    getSentThankingAsync,
    getSentAppreciationAsync,
    getSentCardIdAsync,
  } = props;
  ...
  <Box style={{position:"absolute",top:"12px",right:"320px",background:"#0071e3",padding:"0px",borderRadius:"4px"}}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Appreciation
                {/* ({sentcards?.sentcardsData?.dataValues?.Appreciation}) */}
              </Button>
              <Button
              ...
              >
                Thanking
                {/* ({sentcards?.sentcardsData?.dataValues?.Thanking}) */}
              </Button>
            </Box>
            <TextField
              sx={{
    ...
    column.label
          ...
          {selectedButton === "Thanking" && (
            <Table>
              ...
              {sentcards?.sentThankingData?.cards?.length === 0 ? (
                ...
                <TableBody className="custom-table-body">
                  {sentcards?.sentThankingData?.cards &&
                    sentcards?.sentThankingData?.cards
                        .map((row, rowIndex) => {
                        // Calculate the actual index
                        const actualIndex = page * rowsPerPage + rowIndex;
        ...
        <TablePagination
          ...
          count={
            selectedButton === "All"
              ? sentcards?.sentcardsData?.dataValues?.totalCards
              : selectedButton === "Appreciation"
              ? sentcards?.sentAppreciationData?.dataValues?.AppreciationCount
              : selectedButton === "Thanking"
              ? sentcards?.sentThankingData?.dataValues?.ThankingCount
